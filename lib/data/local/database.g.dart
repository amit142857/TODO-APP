...
class $TodosTable extends Todos with TableInfo<$TodosTable, Todo> {
  ...
  static const VerificationMeta _encryptedTitleMeta =
      const VerificationMeta('encryptedTitle');
  @override
  late final GeneratedColumn<String> encryptedTitle = GeneratedColumn<String>(
      'encrypted_title', aliasedName, false,
      type: DriftSqlType.string, requiredDuringInsert: true);
  static const VerificationMeta _encryptedBodyMeta =
      const VerificationMeta('encryptedBody');
  @override
  late final GeneratedColumn<String> encryptedBody = GeneratedColumn<String>(
      'encrypted_body', aliasedName, false,
      type: DriftSqlType.string, requiredDuringInsert: true);
  ...
  List<GeneratedColumn> get $columns =>
      [id, encryptedTitle, encryptedBody, createdAt];
  @override
    ...
    if (data.containsKey('encrypted_title')) {
      context.handle(
          ...
          encryptedTitle.isAcceptableOrUnknown(
              data['encrypted_title']!, _encryptedTitleMeta));
    } else if (isInserting) {
    ...
    if (data.containsKey('encrypted_body')) {
      context.handle(
          ...
          encryptedBody.isAcceptableOrUnknown(
              data['encrypted_body']!, _encryptedBodyMeta));
    } else if (isInserting) {
      context.missing(_encryptedBodyMeta);
    }
  ...
  Todo map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Todo(
      ...
      encryptedTitle: attachedDatabase.typeMapping.read(
          DriftSqlType.string, data['${effectivePrefix}encrypted_title'])!,
      encryptedBody: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}encrypted_body'])!,
...
class Todo extends DataClass implements Insertable<Todo> {
  ...
  @override
  int get hashCode => Object.hash(id, encryptedTitle, encryptedBody, createdAt);
  @override
...
class $$TodosTableFilterComposer extends Composer<_$AppDatabase, $TodosTable> {
  ...
  ColumnFilters<String> get encryptedBody => $composableBuilder(
      column: $table.encryptedBody, builder: (column) => ColumnFilters(column));
...
class $$TodosTableAnnotationComposer
  ...
  GeneratedColumn<String> get encryptedTitle => $composableBuilder(
      column: $table.encryptedTitle, builder: (column) => column);

  GeneratedColumn<String> get encryptedBody => $composableBuilder(
      column: $table.encryptedBody, builder: (column) => column);
